...
// Load .env for local development (ignored in cloud)
...
// In cloud: reads from Firebase Secrets via process.env
// In local: reads from .env file via dotenv
 ...
 */
exports.createTransaction = functions
    .runWith({
        secrets: ['MIDTRANS_SERVER_KEY', 'MIDTRANS_CLIENT_KEY', 'MIDTRANS_IS_PRODUCTION', 'APP_URL']
    })
